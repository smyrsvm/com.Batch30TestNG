...
public class C01_KeyboardActions extends TestBase {
    ...
    public void test(){
        ...
        */
        ...
        // aramaKutu.sendKeys("samsung A71"); burada nereye gidecegi belli, click e gerek yok
        actions.click(aramaKutu)   //normalde bunda aramakutusu.click de diyorduk.ama biz actions kullandik
                .sendKeys("samsung ")
                .keyDown(Keys.SHIFT)
                .sendKeys("a")
                .keyUp(Keys.SHIFT)
        ...
        /* actions.click(searchBox).sendKeys("sansung ").keyDown(Keys.SHIFT).sendKeys("a")
        .keyUp(Keys.SHIFT).sendKeys("71").sendKeys(Keys.ENTER).perform();

        //Burada clik kullanmak yerine:
        //actions.sendKeys(searchBox,"sansung ").keyDown(Keys.SHIFT)....
