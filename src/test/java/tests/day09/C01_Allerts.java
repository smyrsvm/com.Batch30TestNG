...
// Sag click yapamiyorsak alert bir JS Allert'dur ve
// switchTo() kullanilarak handle edilebilir*/
    ...
    public void acceptAlert(){
        ...
        //Bureda bastaki Assert i sildim.kirmizi verdi-More actions sectim.import static method diyor.
        //TestNG olani sectim.En yukarida import kisminda Assert equals gelmis.equals silip * koyarsak
        //tum Assert clasiindaki tum static methodlari import eder ve bundan sonra bu sekilde kullanabilirim
        //Fakat Soft Aseert icin bu kulanilmaz, onun methodlari statik degil, obje ile geliyor.
    ...
    public void sendKeysAlert(){
        ...
        //yukarida gectik ama her geciste yine kullaniyoruz, asagida oldugu gibi.
        driver.switchTo().alert().accept();
        WebElement resultYaziElementi=driver.findElement(By.id("result"));
        String actualResult=resultYaziElementi.getText();
